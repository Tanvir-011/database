...
SET PAGESIZE 100
SET FEEDBACK ON
-- Keep columns narrow: with a UTF-8 client (NLS_LANG=.AL32UTF8) SQL*Plus sizes each
-- VARCHAR2 column at 3x its width, which makes every table wrap. These formats stop that.
COLUMN emp_name   FORMAT A20
COLUMN dept_name  FORMAT A24
